...
async def verify_variants():
    async with async_playwright() as p:
        ...
        try:
            ...
            # Use specific classes that exist
            await page.locator("button.absolute.bottom-2.right-2.bg-black\\/80").first.click()
            ...
            # Open cart drawer
            await page.locator("div:has-text('Cart')").last.click()
            await asyncio.sleep(1)
